...
public class Service {
    ...
    public void addStudent() {
        ...
        String idCity = scanner.next();
        String query = "insert into lesson24.students2 (last_name, first_name, age, student_group, gender, id_city) values ("
                + "'" + lastName + "'" + ", "
                + "'" + firstName + "'" + ", "
                + age + ", "
                + studentGroup + ", "
    ...
    public void deleteStudent() {
        ...
        String query = "DELETE FROM students2 where id_student = " + id + ";";
        try {
            connection = DriverManager.getConnection(URL, USER_NAME, PASSWORD);
            statement = connection.createStatement();
            statement.execute(query);
